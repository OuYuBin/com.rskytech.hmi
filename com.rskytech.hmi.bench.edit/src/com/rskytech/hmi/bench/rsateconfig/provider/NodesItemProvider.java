...
/**
 * This is the item provider adapter for a {@link com.rskytech.hmi.bench.rsateconfig.Nodes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodesItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RSATEConfigPackage.Literals.NODES__NODE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Nodes.class)) {
			case RSATEConfigPackage.NODES__NODE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RSATEConfigPackage.Literals.NODES__NODE,
				 RSATEConfigFactory.eINSTANCE.createNode()));
	}
