...
/**
 * This is the item provider adapter for a {@link com.rskytech.hmi.bench.rsateconfig.Driver} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Driver_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Driver_version_feature", "_UI_Driver_type"),
				 RSATEConfigPackage.Literals.DRIVER__VERSION,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Driver_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Driver_name_feature", "_UI_Driver_type"),
				 RSATEConfigPackage.Literals.DRIVER__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
