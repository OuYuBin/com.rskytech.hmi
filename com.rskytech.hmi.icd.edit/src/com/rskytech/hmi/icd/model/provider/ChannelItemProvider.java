...
public class ChannelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Channel_datas_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Channel_datas_feature", "_UI_Channel_type"),
				 RSICDConfigPackage.Literals.CHANNEL__DATAS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Channel_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Channel_type_feature", "_UI_Channel_type"),
				 RSICDConfigPackage.Literals.CHANNEL__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RSICDConfigPackage.Literals.CHANNEL__CONFIG);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RSICDConfigPackage.Literals.CHANNEL__CONFIG,
				 RSICDConfigFactory.eINSTANCE.createConfig()));
	}
