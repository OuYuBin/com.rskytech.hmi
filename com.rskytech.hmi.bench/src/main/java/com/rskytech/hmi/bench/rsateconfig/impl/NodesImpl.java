 ...
 * </p>
 * <ul>
 *   <li>{@link com.rskytech.hmi.bench.rsateconfig.impl.NodesImpl#getNode <em>Node</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodesImpl extends MinimalEObjectImpl.Container implements Nodes {
	...
	protected EClass eStaticClass() {
		return RSATEConfigPackage.Literals.NODES;
	}
	...
	public EList<Node> getNode() {
		if (node == null) {
			node = new EObjectContainmentEList<Node>(Node.class, this, RSATEConfigPackage.NODES__NODE);
		}
		return node;
	}
