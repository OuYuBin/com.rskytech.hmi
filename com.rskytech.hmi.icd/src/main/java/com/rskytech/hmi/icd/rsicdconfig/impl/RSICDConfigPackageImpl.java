...
public class RSICDConfigPackageImpl extends EPackageImpl implements RSICDConfigPackage {
	 ...
	 * @see com.rskytech.hmi.icd.rsicdconfig.RSICDConfigPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getICD_Name() {
		return (EAttribute)icdEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(icdEClass, ICD__NAME);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(icdEClass, com.rskytech.hmi.icd.rsicdconfig.ICD.class, "ICD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getICD_Name(), ecorePackage.getEString(), "name", null, 0, 1, com.rskytech.hmi.icd.rsicdconfig.ICD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
