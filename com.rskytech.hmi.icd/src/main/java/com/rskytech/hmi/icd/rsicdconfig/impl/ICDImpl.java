 ...
 * </p>
 * <ul>
 *   <li>{@link com.rskytech.hmi.icd.rsicdconfig.impl.ICDImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ICDImpl extends MinimalEObjectImpl.Container implements ICD {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RSICDConfigPackage.ICD__NAME, oldName, name));
	}
