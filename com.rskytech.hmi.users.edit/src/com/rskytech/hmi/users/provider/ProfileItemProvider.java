...
/**
 * This is the item provider adapter for a {@link com.rskytech.hmi.users.Profile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfileItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsersPackage.Literals.PROFILE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRestrictionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Profile_restriction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Profile_restriction_feature", "_UI_Profile_type"),
				 UsersPackage.Literals.PROFILE__RESTRICTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Profile.class)) {
			case UsersPackage.PROFILE__NAME:
