...
/**
 * This is the item provider adapter for a {@link com.rskytech.hmi.users.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addProfilesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_profiles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_profiles_feature", "_UI_User_type"),
				 UsersPackage.Literals.USER__PROFILES,
				 true,
				 false,
				 true,
				 null,
